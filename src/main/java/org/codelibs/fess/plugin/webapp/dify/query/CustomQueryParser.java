 ...
 */
package org.codelibs.fess.plugin.webapp.dify.query;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.apache.lucene.queryparser.classic.QueryParser.Operator;
import org.codelibs.fess.plugin.webapp.dify.api.QueryRequest;
...
public class CustomQueryParser extends QueryParser {
    ...
    protected org.apache.lucene.queryparser.classic.QueryParser createQueryParser() {
        ...
        LaRequestUtil.getOptionalRequest().ifPresentOrElse(req -> {
            if (req.getAttribute(QueryRequest.QUERY) instanceof final QueryRequest query) {
